...
\label{chapitre.commande}
	...
	\section{Gestion des deux modèles dynamiques exclusifs}
		...
		\label{section.impact_estimator}
			...
			\eq{
				\psi = \frac{g^z\cos\prt{\psi_0+$atan$\prt{\dfrac{h_b}{d_k}}}}{2l}t^2+\dot{\psi}_0t+\psi_0
			}
			...
			\eq{
				t_i = \dfrac{l(\dot{\psi}_0\pm \sqrt{\Delta})}{g^z}
			}
			et la vitesse d'impact estimée $\dot{\psi}_i$ est :
			\eq{
				\dot{\psi}_i = \dfrac{g^zt_i}{l}\cos\prt{\psi_0+$atan$\prt{\dfrac{h_b}{d_k}}}+\dot{\psi}_0
			}
